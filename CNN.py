...
if __name__ == "__main__":
    ...
    model.add(layers.Conv2D(64, (3, 3), activation='relu', input_shape=(480, 480, 3),kernel_regularizer=(tf.keras.regularizers.L1(1e-3)),activity_regularizer=(tf.keras.regularizers.L1(1e-2))))
    model.add(layers.MaxPool2D())
    model.add(layers.Conv2D(128, (3, 3), activation='relu',kernel_regularizer=(tf.keras.regularizers.L1(1e-3)),activity_regularizer=(tf.keras.regularizers.L1(1e-2))))
    model.add(layers.MaxPool2D())
